...
public:
  BasicBlock(Instruction **insns, bb_type_t type, int first, int last);

  void setType(bb_type_t type) { this->type = type; }
...
private:
  ...
  void handleRegisterTablesPrev(Instruction **rtab, Instruction **wtab,
                                Instruction *insn);

  void handleRegisterTablesAfter(Instruction **rtab, Instruction **wtab,
                                 Instruction *insn);
