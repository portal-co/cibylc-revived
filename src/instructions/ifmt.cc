...
public:
  Ifmt(const char *what, uint32_t address, int opcode, MIPS_register_t rs,
...
public:
  Addi(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
       MIPS_register_t rd, int32_t extra)
      : Ifmt("iadd", address, opcode, rs, rt, rd, extra) {}
