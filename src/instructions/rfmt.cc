...
public:
  Rfmt(const char *what, uint32_t address, int opcode, MIPS_register_t rs,
       MIPS_register_t rt, MIPS_register_t rd)
      : Instruction(address, opcode, rs, rt, rd, 0) {
    this->bc = what;
  }
...
public:
  Addu(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
       MIPS_register_t rd)
      : Rfmt("iadd", address, opcode, rs, rt, rd) {}
...
public:
  Subu(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
       MIPS_register_t rd)
      : Rfmt("isub", address, opcode, rs, rt, rd) {}
...
public:
  Nor(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
      MIPS_register_t rd)
      : Rfmt("", address, opcode, rs, rt, rd) {}
...
public:
  ...
  int fillSources(int *p) { return this->addToRegisterUsage(this->rt, p); };
};
