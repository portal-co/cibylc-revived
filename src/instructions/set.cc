...
public:
  TwoRegisterSetInstruction(const char *what, uint32_t address, int opcode,
                            ...
                            MIPS_register_t rd)
      : Rfmt(what, address, opcode, rs, rt, rd) {}
...
public:
  Slt(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
      MIPS_register_t rd)
      : TwoRegisterSetInstruction("", address, opcode, rs, rt, rd) {}
...
public:
  Sltu(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
       MIPS_register_t rd)
      : TwoRegisterSetInstruction("", address, opcode, rs, rt, rd) {}
...
public:
  ...
  int fillDestinations(int *p) { return this->addToRegisterUsage(this->rt, p); }
...
public:
  Slti(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
       int32_t extra)
      : OneRegisterSetInstruction("", address, opcode, rs, rt, extra) {}
...
public:
  Sltiu(uint32_t address, int opcode, MIPS_register_t rs, MIPS_register_t rt,
        int32_t extra)
      : OneRegisterSetInstruction("", address, opcode, rs, rt, extra) {}
